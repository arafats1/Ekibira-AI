  ...
  return (
    <section id="impact" className="py-24 md:py-32 px-6 bg-[#eef2e6]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {metrics.map((metric, i) => (
            ...
            >
              ...
              <div className="text-[#1a2e1a] font-semibold mt-1 font-[family-name:var(--font-display)]">
                {metric.label}
              </div>
              <p className="text-[#6b7c6b] text-sm mt-2 font-[family-name:var(--font-body)]">
                {metric.description}
              </p>
            </div>
          ))}
        ...
        {/* SDG Alignment */}
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#eef2e6]" style={{ boxShadow: "var(--card-shadow)" }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {sdgs.map((sdg, i) => (
              <div
                key={i}
                className={`${sdg.color} text-white rounded-xl p-4 text-center`}
              >
                <div className="text-2xl font-bold font-[family-name:var(--font-display)]">
                  SDG {sdg.number}
                </div>
                <div className="text-xs mt-1 opacity-90 font-[family-name:var(--font-body)]">
                  {sdg.title}
                </div>
              </div>
            ))}
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-6 text-center border border-[#eef2e6]" style={{ boxShadow: "var(--card-shadow)" }}>
