export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#2d6a4f]/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#d4a843]/10 rounded-full blur-3xl animate-float delay-300" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        {/* Main headline */}
        <h1 className="animate-fade-in-up delay-100 text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.05] tracking-tight mb-8 drop-shadow-lg">
        ...
        {/* Subheadline */}
        <p className="animate-fade-in-up delay-200 text-lg md:text-xl text-white/85 max-w-2xl mx-auto leading-relaxed mb-12 font-[family-name:var(--font-body)]">
        ...
        <div className="animate-fade-in-up delay-300 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="#problem"
            className="border-2 border-white/30 text-white hover:bg-white/10 font-semibold px-8 py-4 rounded-full text-lg transition-all backdrop-blur-sm"
          >
            Learn More
          </a>
        </div>
        ...
        {/* Stats bar */}
        <div className="animate-fade-in-up delay-500 mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/15 hover:bg-white/15 transition-colors"
            >
              <div className="text-lg mb-1">{stat.icon}</div>
              <div className="text-2xl md:text-3xl font-bold text-[#4ade80] font-[family-name:var(--font-display)]">
                {stat.value}
              </div>
