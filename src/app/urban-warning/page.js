              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3 mb-8 pb-6 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 font-[family-name:var(--font-body)]">
                        {selectedArea.division ? `${selectedArea.division}, ` : ""}{selectedArea.city || ""}{selectedArea.country ? `, ${selectedArea.country}` : ""} · {new Date().toLocaleDateString("en-UG", { year: "numeric", month: "long", day: "numeric" })}
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="pt-6 border-t border-gray-100">
                  ...
                  <p className="text-[10px] text-gray-400 mt-3 font-[family-name:var(--font-body)]">
                    Generated by Kibira AI · {new Date().toLocaleString("en-UG")} · This report is for informational purposes. Local authorities should verify recommendations.
                  </p>
                </div>
              </div>
            </div>
